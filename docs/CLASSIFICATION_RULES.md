...
- **T-002 — Janela mecânica:** formar turnos em blocos de 2 segundos.
...
- **T-007 — Turno parcial:** o primeiro turno pode estar cortado pela sessão e deve ser marcado como parcial.
...
- **A-009 — Turno parcial:** não penalizar uptime quando a borda removeu a evidência necessária.
